...
For more information, see also the [_Building KeePassXC_](https://github.com/DevGn0m3/KeePassXL/wiki/Building-KeePassXC) page on the wiki.
...
* [Set up Build Environment on Linux](https://github.com/DevGn0m3/KeePassXL/wiki/Set-up-Build-Environment-on-Linux)
* [Set up Build Environment on Windows](https://github.com/DevGn0m3/KeePassXL/wiki/Set-up-Build-Environment-on-Windows)
* [Set up Build Environment on macOS](https://github.com/DevGn0m3/KeePassXL/wiki/Set-up-Build-Environment-on-macOS)

## Build Steps

We recommend using the release tool to perform builds, please read up-to-date instructions [on our wiki](https://github.com/DevGn0m3/KeePassXL/wiki/Building-KeePassXC#building-using-the-release-tool).
...
1. Download the KeePassXC [source tarball](https://keepassxc.org/download#source) or check out the latest version from our [Git repository](https://github.com/DevGn0m3/KeePassXL).

   To clone the project from Git, `cd` to a suitable location and run

   ```
   git clone https://github.com/DevGn0m3/KeePassXL.git
   ```
...
For more detailed build instructions for each platform, please refer to the [GitHub wiki](https://github.com/DevGn0m3/KeePassXL/wiki/Building-KeePassXC).
...
You can create a package to redistribute KeePassXC (zip, deb, rpm, dmg, etc..). Refer to [keepassxc-packaging](https://github.com/DevGn0m3/KeePassXL-packaging) for packaging scripts.
